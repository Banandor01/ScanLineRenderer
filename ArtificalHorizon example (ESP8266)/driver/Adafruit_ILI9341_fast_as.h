...
private:
 ...
 inline void transmitArray(uint16_t *data, int number) {
	 /* hspi_wait_ready();  */ hspi_send_Array(data, number);
...
public:
  ...
  void     begin(void),
	  ...
	  drawFastHColors(int16_t x, int16_t y, int16_t number, uint16_t * colors),
