...
ICACHE_FLASH_ATTR Adafruit_ILI9341::Adafruit_ILI9341() : Adafruit_GFX(ILI9341_TFTWIDTH, ILI9341_TFTHEIGHT) {
	tabcolor = 0;
}
...
void Adafruit_ILI9341::drawFastHColors(int16_t x, int16_t y, int16_t number, uint16_t * colors) {	
	setAddrWindow(x, y, x + number - 1, y);
	transmitArray(colors, number);
}
